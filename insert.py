...
for i, item in enumerate(json_obj):
    ...
    solution = validate_string(item.get("solution",None))
    cursor.execute("INSERT INTO questions (question,op1,op2,op3,op4,correct,solution) VALUES (%s,%s,%s,%s,%s,%s,%s)",
                   (question, op1, op2, op3, op4, correct,solution))
con.commit()
con.close()
