...
function open3(){
         x.innerHTML= "When 0.1 g of the salt is taken in a test tube and 1-2 mL of conc. H<sub>2</sub>SO<sub>4</sub> is added, a colourless gas with pungent smell, which gives dense white fumes when a rod dipped in NH4OH is brought near the mouth of test tube is evolved."
         x.style.display="block"
         z.style.display="block"
        a.style.display="block"
         var y=document.getElementById("giffy");
